...
namespace SimplePuzzleGame
{
    public partial class Form1 : Form
    {
        ...
        private void shuffleButtons() //перемещение кнопок
        {
            ...
            movesNumber = 0;
            lblNoOfMoves.Text = "Количество перемещений : " + movesNumber; 
        }
        ...
        private void checkOrder()
        {
            ...
            MessageBox.Show("Игра окончена! Вы сделали " + movesNumber + " перемещений.");
        }
